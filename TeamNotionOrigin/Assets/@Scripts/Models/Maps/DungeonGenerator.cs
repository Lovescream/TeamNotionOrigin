...
namespace Dungeon
{
    public class DungeonGenerator
    {
        ...
        public DungeonGenerator(Vector2Int size, int margin, int maxDepth, float minDivideRate, float maxDivideRate)
        {
            ...
            Background = new("Background", Grid, Origin, -10, false, "roomTile_7");
            Room = new("Room", Grid, Origin, -9, true, "roomTile_7");
            Road = new("Road", Grid, Origin, -8, true, "roadTile_7");
            Wall = new("Wall", Grid, Origin, -7, true, "wallTile_7");
            Obstacle = new("Obstacle", Grid, Origin, -7, true, null);
            Obstacle.SetTile(new Tile[] {
                Main.Resource.Load<Tile>("obstacle_11"),
                Main.Resource.Load<Tile>("obstacle_13"),
            });
        }
